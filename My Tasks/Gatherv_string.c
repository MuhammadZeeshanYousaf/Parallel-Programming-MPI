// String spliting to different prcesses
...
#define nstrings 5
const char *const strings[nstrings] = {"Hello","Dear!","Muhammad","Zeeshan","Yousaf!"};
...
int main(int argc, char **argv) {
    ...
    MPI_Gatherv(mystring, mylen, MPI_CHAR, totalstring, recvcounts, displs, MPI_CHAR,
                root, MPI_COMM_WORLD);
